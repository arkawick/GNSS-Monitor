...
public class ConfigUtils {
    ...
    private static final Map<ConfigTypes, String> TYPE_TITLES = Map.ofEntries(
            ...
            Map.entry(ConfigTypes.DUMP_GMS_LS, "dumpsys ("+ DUMPSYS_GMS_LS_ARGS[0] +")"),
            Map.entry(ConfigTypes.DUMP_GMS_E911, "dumpsys ("+ DUMPSYS_GMS_E911_ARGS[0] +")"),
    ...
    public static String getNfwLocationPackage(@NonNull Context context) {
        final String LOC_ATTRIB_PKG = "com.example.android.locationattribution";
