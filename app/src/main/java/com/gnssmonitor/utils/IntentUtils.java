...
import com.gnssmonitor.MainActivity;
...
public class IntentUtils {
    ...
    public static Intent createLogalongLauncherIntent() {
        // Generic logging app intent - customize with your preferred logging app package
        final String LOGALONG_PKG = "com.example.logalong";
